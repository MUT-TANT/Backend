...
class GoalsController {
    ...
    async getUserPortfolio(req, res) {
        try {
            ...
            const provider = blockchain_service_1.blockchainService.getProvider();
            // Fetch ETH balance
            const ethBalanceWei = await provider.getBalance(address);
            const ethBalance = blockchain_service_1.blockchainService.formatEther(ethBalanceWei);
            ...
            const tokens = await Promise.all(Object.entries(TOKEN_ADDRESSES).map(async ([symbol, tokenAddress]) => {
                ...
                return {
                    ...
                    balance: blockchain_service_1.blockchainService.formatUnits(balance, decimals),
