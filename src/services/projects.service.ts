// Curated list of Octant-approved public goods projects
...
const APPROVED_PROJECTS: PublicGoodsProject[] = [
  {
    id: 'octant-general',
...
class ProjectsService {
  ...
  getProjectByAddress(address: string): PublicGoodsProject | null {
    const project = APPROVED_PROJECTS.find(
  ...
  searchProjects(query: string): PublicGoodsProject[] {
    ...
    return APPROVED_PROJECTS.filter(p =>
